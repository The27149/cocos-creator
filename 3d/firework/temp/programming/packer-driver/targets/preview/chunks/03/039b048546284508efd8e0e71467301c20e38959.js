  ...
  return {
    ...
    execute: function () {
      ...
      _export("Roam", Roam = (_dec = ccclass('Roam'), _dec2 = property(Node), _dec(_class = (_class2 = class Roam extends Component {
        ...
        touchMove(e) {
          var dx = e.getDeltaX() * this.angleScale,
        ...
        roundOther(target, axis, distance) {
          if (distance === void 0) {
            distance = 10;
          }
...
//# sourceMappingURL=039b048546284508efd8e0e71467301c20e38959.js.map