    ...
    execute: function () {
      ...
      _export("Point", Point = (_dec = ccclass('Point'), _dec2 = property(Label), _dec3 = property(Node), _dec(_class = (_class2 = class Point extends Component {
        ...
        scaleSelf(v) {
          ...
          this.coordinate.node.setScale(v3(v, v, 1)); // this.coordinate.fontSize = v * this.originFontSize;
...
//# sourceMappingURL=75c7811fd8b66e86ad9adcafcb5629d3305eadb2.js.map