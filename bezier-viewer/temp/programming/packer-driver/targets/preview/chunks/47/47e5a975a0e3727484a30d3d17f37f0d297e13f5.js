  ...
  return {
    ...
    execute: function () {
      ...
      _export("Paper", Paper = (_dec = ccclass('Paper'), _dec2 = property(Prefab), _dec3 = property(Color), _dec4 = property(CCFloat), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class Paper extends Component {
        ...
        drawCtrls() {
          for (var i = 0; i < this.ctrlContainer.children.length; i++) {
            var p = this.ctrlContainer.children[i];
            if (p && !this.ctrlPoints[i]) this.pointPool.putNode(p);
...
//# sourceMappingURL=47e5a975a0e3727484a30d3d17f37f0d297e13f5.js.map