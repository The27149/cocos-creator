System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, Sprite, Color, UITransform, v3, v2, CCFloat, Graphics, Label, director, Canvas, NodeEventType, NodeFactory, Point, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, Paper;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Prefab', 'Vec2', 'Sprite', 'Color', 'ColorKey', 'color', 'UITransform', 'Vec3', 'v3', 'v2', 'CCFloat', 'Graphics', 'Label', 'find', 'director', 'Canvas', 'NodeEventType', 'EventTouch', 'EventMouse']);
      ...
      _export("Paper", Paper = (_dec = ccclass('Paper'), _dec2 = property(Prefab), _dec3 = property(Color), _dec4 = property(CCFloat), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Label), _dec(_class = (_class2 = class Paper extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "paperScale", _descriptor7, this);
        ...
        onMouseWheel(e) {
          ...
          var v_old = this.node.scale.x;
          var v = long > 0 ? v_old * 1.1 : v_old * 0.9;
        ...
        updateCtrls() {
          ...
          for (var i = 0; i < this.ctrlPoints.length; i++) {
            var node = this.ctrlContainer.children[i];
        ...
        drawCtrls() {
          ...
          if (this.ctrlContainer.children.length > this.ctrlPoints.length) {
            for (var j = this.ctrlPoints.length; j < this.ctrlContainer.children.length; j++) {
              var node = this.ctrlContainer.children[j];
              this.pointPool.putNode(node);
            }
          }

          for (var i = 0; i < this.ctrlPoints.length; i++) {
            var p = this.ctrlContainer.children[i];

            if (!p) {
              p = this.pointPool.getNode();
              p.parent = this.ctrlContainer;
              var ui = p.getComponent(UITransform);
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "paperScale", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=daf3becc4744ec8b5ef41f82240d81b270f7f9f3.js.map