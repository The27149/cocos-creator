      ...
      _export("Paper", Paper = (_dec = ccclass('Paper'), _dec2 = property(Prefab), _dec3 = property(Color), _dec4 = property(CCFloat), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Label), _dec(_class = (_class2 = class Paper extends Component {
        ...
        drawCtrls() {
          ...
          for (var i = 0; i < points.length; i++) {
            ...
            var x = points[i].x,
                y = points[i].y;
            child.setPosition(v3(x, y));
            child.getChildByName('coordinate').getComponent(Label).string = "P" + i + "(x:" + x + ", y:" + y + ")";
          }
        }
        /**方式2： canvas2d绘制 */
...
//# sourceMappingURL=837f9795c01dba6390401a13bce0bb809cdae42f.js.map