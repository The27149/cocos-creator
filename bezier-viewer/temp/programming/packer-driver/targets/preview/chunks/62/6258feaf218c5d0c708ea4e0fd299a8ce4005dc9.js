System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Paper", Paper = (_dec = ccclass('Paper'), _dec2 = property(Prefab), _dec3 = property(Color), _dec4 = property(CCFloat), _dec5 = property(CCFloat), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Button), _dec11 = property(Button), _dec12 = property(Button), _dec13 = property(Button), _dec14 = property(Node), _dec(_class = (_class2 = class Paper extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "helpBtn", _descriptor12, this);

          _initializerDefineProperty(this, "helpContent", _descriptor13, this);
        ...
        drawCtrls() {
          ...
          for (var i = 0; i < points.length; i++) {
            ...
            if (!child) {
              ...
              ui.width = ui.height = this.lineWidth * 5 * (1 / this.node.scale.x);
        ...
        drawLines(x, y, i) {
          ...
          g.lineWidth *= 1 / this.node.scale.x;
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "helpBtn", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "helpContent", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=6258feaf218c5d0c708ea4e0fd299a8ce4005dc9.js.map