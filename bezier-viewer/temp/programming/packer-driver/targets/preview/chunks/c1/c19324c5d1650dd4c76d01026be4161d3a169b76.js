System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Color, UITransform, v3, v2, NodeFactory, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Paper;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Prefab', 'Vec2', 'Sprite', 'Color', 'ColorKey', 'color', 'UITransform', 'Vec3', 'v3', 'v2']);
      ...
      _export("Paper", Paper = (_dec = ccclass('Paper'), _dec2 = property(Prefab), _dec3 = property(Color), _dec4 = property({
        type: Number
      }), _dec(_class = (_class2 = class Paper extends Component {
        constructor() {
          super(...arguments);
        ...
        onLoad() {// this.pointPool.init(this.pointNum);
          // this.randomDraw();
        }
        ...
        draw(ctrls) {
          ...
          for (var i = 0, len = this.pointNum; i < len; i++) {
            ...
            var ui = node.getComponent(UITransform); // ui.width = ui.height = this.lineWidth;
...
//# sourceMappingURL=c19324c5d1650dd4c76d01026be4161d3a169b76.js.map