System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Paper", Paper = (_dec = ccclass('Paper'), _dec2 = property(Prefab), _dec3 = property(Color), _dec4 = property(CCFloat), _dec5 = property(CCFloat), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Button), _dec11 = property(Button), _dec(_class = (_class2 = class Paper extends Component {
        constructor() {
          super(...arguments);
        ...
        onAddCtrl() {
          ...
          var temp = this.ctrlPoints.slice(idx + 1);
          this.ctrlPoints.splice(idx + 1).concat(v2()).concat(temp);
          this.draw();
        }
        /**减少控制点 */
...
//# sourceMappingURL=0887fba74a632b8f081045b5d52e801981591cc5.js.map